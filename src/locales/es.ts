...
export const es: Dictionary = {
  ...
  settings: { title: 'Configuración', language: 'Idioma', theme: 'Tema', currency: 'Moneda', timezone: 'Zona horaria', save: 'Guardar cambios', saving: 'Guardando...', success: 'Configuración aplicada con éxito.', dateFormat: 'Formato de fecha', numberFormat: 'Formato numérico', noChanges: 'Sin cambios pendientes.' },
  onboarding: {
