...
## Análise estratégica no replayer (MVP)
- O painel estratégico é marcado como **Análise sugerida / Heurística / IA assistente**.
- A range matrix e recomendações atuais são heurísticas para UX e validação de produto.
- A arquitetura foi separada para permitir plugar solver real/serviço de IA no futuro sem refazer UI.
